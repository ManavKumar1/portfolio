...
const socialLinks = [
  {
    icon: "github", // Change icon to string
  ...
  {
    icon: "mail", // Change icon to string
    url: "mailto:reachformanav@gmail.com",
    label: "Email",
  },
  // {
  //   icon: "twitter", // Uncomment if needed
  //   url: "https://twitter.com/yourusername",
  //   label: "Twitter",
  // }
];

const resume = "../../../assets/Resumes/Manav_SDE_RESUME.pdf";
const aboutimg = "../../assets/ProfilePhoto/img2.jpg";
const qaResume = "../../assets/Resumes/Manav_Resume_QA.pdf";
